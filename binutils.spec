...
#           present.  See PR 22431 and BZs 1515340, 1515347, 1513014
# Lifetime: Fixed in 2.30.
Patch26: binutils-2.27-ppc64-discarded-plt-sections.patch
# Purpose:  Stop strip from replacing unknown relocs with null relocs.
#           Make it return an error status and not strip any file containing
#           unknown relocs.
# Lifetime: Fixed in 2.31.
Patch27: binutils-strip-unknown-relocs.patch
...
%changelog
* Mon Mar 05 2018 Matt Newsome  <mnewsome@redhat.com> 2.28-11
- Version bump to align with DTS 7.1 RHEL6 rebuild
 
* Tue Feb 27 2018 Nick Clifton  <nickc@redhat.com> 2.28-10
- Stop strip from replacing unknown relocs with null relocs.
  (#1545386)

* Wed Nov 29 2017 Nick Clifton  <nickc@redhat.com> 2.28-9
